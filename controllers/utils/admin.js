...
document.querySelector('title').textContent = 'Vehicle Management - Dashboard';
                    ...
                    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
                        <div class="container">
                            <a class="navbar-brand" href="dashboard.html">
                                <img src="../../resources/img/logo.png" alt="Vehicle Management" width="50">
                            </a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarContent">
                                <ul class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a class="nav-link" href="vehiculo.html">Vehículos</a>
                                    </li>
                                    <li class="nav-item">
            ...
            MAIN.insertAdjacentHTML('afterend', `
                <footer>
                    <nav class="navbar fixed-bottom bg-body-tertiary">
                        <div class="container">
                            <div>
                                <p><a class="nav-link" href="https://github.com/dacasoft/vehicle-management" target="_blank"><i class="bi bi-github"></i> Vehicle Management</a></p>
