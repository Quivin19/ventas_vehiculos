/*
*   Controlador de uso general en las páginas web del sitio público.
...
document.querySelector('title').textContent = 'Vehicle Management - Store';
            ...
            MAIN.insertAdjacentHTML('beforebegin', `
                <header>
                    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
                        <div class="container">
                            <a class="navbar-brand" href="index.html"><img src="../../resources/img/logo.png" height="50" alt="Vehicle Management"></a>
            ...
            <nav class="navbar fixed-bottom bg-body-tertiary">
                <div class="container">
                    <div>
                        ...
                        <p><i class="bi bi-c-square"></i> 2024-2024 Todos los derechos reservados</p>
                    </div>
                    <div>
                        <h6>Contáctanos</h6>
                        <p><i class="bi bi-envelope"></i> contact@vehiclestore.com</p>
                    </div>
                </div>
            </nav>
        </footer>
